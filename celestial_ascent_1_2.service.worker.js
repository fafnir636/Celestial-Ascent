...
/** @type {string} */
const CACHE_VERSION = '1.2-final-rc|502e4b81c103fcd87bdb';
/** @type {string} */
const CACHE_PREFIX = 'Celestial Ascent-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'celestial_ascent_1_2.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["index.html", "celestial_ascent_1_2.144x144.png", "celestial_ascent_1_2.180x180.png", "celestial_ascent_1_2.512x512.png", "celestial_ascent_1_2.apple-touch-icon.png", "celestial_ascent_1_2.audio.position.worklet.js", "celestial_ascent_1_2.audio.worklet.js", "celestial_ascent_1_2.icon.png", "celestial_ascent_1_2.js", "celestial_ascent_1_2.manifest.json", "celestial_ascent_1_2.offline.html", "celestial_ascent_1_2.pck", "celestial_ascent_1_2.png", "celestial_ascent_1_2.wasm"];
