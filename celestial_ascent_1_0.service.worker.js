...
/** @type {string} */
const OFFLINE_URL = 'celestial_ascent_1_0.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["index.html", "celestial_ascent_1_0.144x144.png", "celestial_ascent_1_0.180x180.png", "celestial_ascent_1_0.512x512.png", "celestial_ascent_1_0.apple-touch-icon.png", "celestial_ascent_1_0.audio.position.worklet.js", "celestial_ascent_1_0.audio.worklet.js", "celestial_ascent_1_0.icon.png", "celestial_ascent_1_0.js", "celestial_ascent_1_0.manifest.json", "celestial_ascent_1_0.offline.html", "celestial_ascent_1_0.png"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["celestial_ascent_1_0.wasm","celestial_ascent_1_0.pck"];
